let sort = document.getElementById('content')

function filterByPrice() {
    let from = document.getElementById("amountFrom").value;
    let to = document.getElementById("amountTo").value;
    ...
    $.ajax({
        ...
        type: "GET",
        url: "http://localhost:8081/products/find-by-price?from=" + from + "&to=" + to,
            ...
            <div class="sidebar_section" style="padding: 10px;">
                ...
                <div class="sidebar_section">
                    <div class="sidebar_title">
                        ...
                        <input type="text" id="amountFrom" style="border:0; color:#ece8e8" placeholder="From Price">
                        <input type="text" id="amountTo" style="border:0; color:#fffdfd" placeholder="To Price">
